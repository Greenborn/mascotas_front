    ...
    <ion-grid>
        <ion-row class="ion-justify-content-center ion-align-items-center">
            <ion-col size-xs="12" size-sm="12" size-md="10" size-lg="8">
                ...
                <ion-row>
                    <ion-col size-xs="12" size-sm="10" size-md="6" size-lg="4">
                        <ion-card>
                            ...
                            <ion-card-content>
                                <ion-grid>
                                    ...
                                    <ion-row class="ion-justify-content-center ion-align-items-center">
                                        <ion-col size="auto">
                                            <ion-button @click="descargar_qr"><ion-icon slot="icon-only" :icon="cloudDownloadOutline"></ion-icon>&nbsp; Descargar</ion-button>
                                        </ion-col>
                                    </ion-row>
                                </ion-grid>
                            </ion-card-content>
