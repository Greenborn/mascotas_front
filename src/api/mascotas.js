...
export function get_qr( cod ) {  return service({ url: "/mascotas/get_qr?cod="+cod,  method: 'get'  }) }
...
export function fue_encontrada( data ){ return service({  url: "/mascotas/fue_encontrada",  method: 'put', data  }) }